  ...
  <div class="col-lg-12">
    ...
    <div class="card">
     ...
     <tr>
       ...
       <td> <a href="postuladosCalificador.php?cc=<?php echo $categoriasActivas[$i]->id ?>"> <button class="btn btn-success bi bi-bookmark-check" type="button" name="button"></button> </a></td>
     </tr>
   <?php } ?>
          </tbody>
        </table>
